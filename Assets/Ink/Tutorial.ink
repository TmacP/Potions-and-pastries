...
- "Fantastic, now let's look at what you picked up. Open your inventory by pressing `TAB`. After close it by pressing `TAB` again. Do this now then come back and I'll explain how to add the ingredients into your service deck"
+ [Continue]
-> DONE
